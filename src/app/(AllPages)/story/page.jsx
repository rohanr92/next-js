    ...
    return (
        <div>
            <div className='text-center mt-10'>
                <div><h2 className='text-3xl font-bold'>Our Story</h2>
                <p>Learn about the journey of our team members and how they became part of our story.</p></div>

                <div className='p-7 grid md:grid-cols-3 gap-3'>
                {storyData.map((story) => (
